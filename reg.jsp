    ...
    <body>
		...
		<div class="testbox1">
                    ...
                    <form action="registration.jsp" method="POST">
                        <table cellspacing="2xp">
                        <tr><td>USERNAME</td><td>:</td><td><input type="text" name="uname"  required /></td></tr>
                        ...
                        <tr><td>COUNTRY</td><td>:</td><td><input type="text" name="con" required /></td></tr>
                        </table>
		  <br />
		  <br />
